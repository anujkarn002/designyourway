...
<div class="flex justify-center">
	...
	<div class="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4">
		<img class="w-full h-56 object-cover object-center" src="successkid.jpg" alt="avatar">
		<div class="flex items-center px-6 py-3 bg-gray-900">
			<svg class="h-6 w-6 text-white fill-current" viewBox="0 0 512 512">
				<path d="M256 48C150 48 64 136.2 64 245.1v153.3c0 36.3 28.6 65.7 64 65.7h64V288h-85.3v-42.9c0-84.7 66.8-153.3 149.3-153.3s149.3 68.5 149.3 153.3V288H320v176h64c35.4 0 64-29.3 64-65.7V245.1C448 136.2 362 48 256 48z" />
			</svg>
			<h1 class="mx-3 text-white font-semibold text-lg">Listening</h1>
		</div>
		<div class="py-4 px-6">
			<h1 class="text-2xl font-semibold text-gray-800">Anuj Karn</h1>
			<p class="py-2 text-lg text-gray-700">Reach me out</p>
			<div class="flex items-center mt-4 text-gray-700">
				...
				<h1 class="px-2 text-sm">DYW Author</h1>
			</div>
			<div class="flex items-center mt-4 text-gray-700">
				<svg class="h-6 w-6 fill-current" viewBox="0 0 512 512">
					<path
				...
				<h1 class="px-2 text-sm">Kathmandu, Nepal</h1>
			</div>
			<div class="flex items-center mt-4 text-gray-700">
				<svg class="h-6 w-6 fill-current" viewBox="0 0 512 512">
					<path
				...
				<h1 class="px-2 text-sm">
					<a class="hover:underline hover:text-green-600" href="mailto:anujkarn002@gmail.com">anujkarn002@gmail.com</a>
				</h1>
			</div>
		</div>
	</div>
